...
def run(ip,port,index):
    ...
    if ((r1.status_code == 200) and 'uid' in r1.text) or ((r2.status_code == 202) and 'Vulnerable' in r3.text):
        ...
        return ('<font color="#FF0000">[+]The target weblogic has a JAVA deserialization vulnerability:{}<br>[+]Your current permission is:  {}</font>'.format((VUL[index]),r1.text.replace('whoami : \r\n', '')))
    else:
